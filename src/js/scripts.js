...
const pageContent = {
    ...
    partnerWithUs: {
        cards: [
            {
                title: "Transform Your Cannabis Business",
                content: "Join Baltimore's premier cannabis delivery network and revolutionize your business reach. Our cutting-edge platform connects you with a rapidly growing network of verified medical cannabis patients, while our advanced technology ensures seamless operations and maximum security.",
                icon: '💎',
                features: [
                    { icon: '📈', text: 'Expand Your Market Reach' },
                ...
                highlight: "Be part of Baltimore's fastest-growing cannabis delivery network. Our platform is designed to enhance your business while maintaining full compliance and security.",
                cta: {
            ...
            },
            {
                ...
                content: "Experience the future of cannabis delivery with our state-of-the-art platform. We provide everything you need to expand your reach and boost your revenue.",
                icon: '🌟',
                features: [
                    { icon: '📊', text: 'Advanced Analytics Dashboard' },
                    { icon: '🚀', text: 'Priority Delivery System' },
                ...
                highlight: "Ready to transform your business? Contact us today to discuss partnership opportunities and learn how GrassApp can help grow your business.",
                cta: {
                    text: "Email Us Now",
                    link: "mailto:contact@thegrassapp.com"
                }
